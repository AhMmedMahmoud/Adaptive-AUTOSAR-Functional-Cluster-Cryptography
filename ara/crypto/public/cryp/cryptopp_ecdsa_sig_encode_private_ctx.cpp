...
namespace ara
{
    namespace crypto
    {
        namespace cryp
        { 
            const std::string CryptoPP_ECDSA_SigEncodePrivateCtx::mAlgName("ecdsa");

            /***************** constructor **********************/
            
            CryptoPP_ECDSA_SigEncodePrivateCtx::CryptoPP_ECDSA_SigEncodePrivateCtx(): mKey(nullptr),
            ...
            */
            CryptoPrimitiveId::Uptr CryptoPP_ECDSA_SigEncodePrivateCtx::GetCryptoPrimitiveId () const noexcept
            {                    
            ...
            */
            bool CryptoPP_ECDSA_SigEncodePrivateCtx::IsInitialized () const noexcept
            {
            ...
            std::size_t CryptoPP_ECDSA_SigEncodePrivateCtx::GetMaxInputSize (bool suppressPadding) const noexcept
            {
                return 10; // to change in future
            }

            std::size_t CryptoPP_ECDSA_SigEncodePrivateCtx::GetMaxOutputSize (bool suppressPadding) const noexcept
            {
                return 10; // to change in future
            }

            ara::core::Result<ara::core::Vector<ara::core::Byte>> CryptoPP_ECDSA_SigEncodePrivateCtx::SignAndEncode (ReadOnlyMemRegion in) const noexcept
            {
            ...
            ara::core::Result<void> CryptoPP_ECDSA_SigEncodePrivateCtx::SetKey (const PrivateKey &key) noexcept
            {
                try
                {
