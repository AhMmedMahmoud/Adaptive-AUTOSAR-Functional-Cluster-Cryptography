...
#include "cryobj/cryptopp_ecdsa_sha_256_public_key.h"
...
namespace ara
{
    namespace crypto
    {
        namespace cryp
        {
            class CryptoPP_ECDSA_SHA_256_MsgRecoveryPublicCtx : public MsgRecoveryPublicCtx
            {
            public:
                /******************* constants **********************/
            ...
            private:      
                /*****************  attributes **********************/
                CryptoPP_ECDSA_SHA_256_PublicKey *mKey;
                CryptoPP_CryptoPrimitiveId mPId;
                helper::setKeyState mSetKeyState;

            public:
                /***************** constructor **********************/
                CryptoPP_ECDSA_SHA_256_MsgRecoveryPublicCtx();
