...
namespace ara
{
    namespace core
    {
        ...
        InstanceSpecifier::InstanceSpecifier(std::string mIpAddress, uint16_t mPort) : mIpAddress{mIpAddress}, mPort{mPort}
        {
        }
        ...
        std::string InstanceSpecifier::GetIpAddress() const {
            return mIpAddress;
        }

        uint16_t InstanceSpecifier::GetPort() const {
            return mPort;
        }
